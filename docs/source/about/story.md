...
QuickForm的原型做好后，谢作如分别联系了方建文和林淼焱，说我们做个有趣的项目吧。方建文问，技术支持来自哪里呢？他问的是哪个企业来提供技术支持。谢作如说，AI+林淼焱和AI+谢作如，够不够？

方建文和林淼焱是师生关系。实际上方建文的很多学生，也是谢作如的学生。QuickForm的顺利推进，源自团队间的默契和信任。

这个软件要开放，让大家用。那就开放吧。

这个软件要开源，让老师们自己更新、维护。那就开源吧。

……

QuickForm发布后，谢作如在公众号上写了一篇文章，然后转发在朋友圈上。就这么简单，一个月内注册用户接近1000。用户基本上是老师，来自全国各地。


## QuickForm是一个AI原生项目

QuickForm做了几天？就两天。中间还因为对Trae不熟悉，走了弯路。要不然，一天足够了。

有人问，“QuickForm”这个名字挺好的，其实就是Trae取的。

要解决AI带来的问题，用AI编写了一个新工具。采集到的数据，再借助AI进行分析。每一个环节和AI有关。
